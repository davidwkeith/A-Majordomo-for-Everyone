...
<body class="landing">
  ...
  <div class="share-section">
    ...
    <div class="share-links">
      <a href="https://bsky.app/intent/compose?text=${encodeURIComponent(meta.title + ' — ' + meta.subtitle + '\n\nhttps://majordomo.dwk.io/')}" target="_blank" rel="noopener" class="share-btn share-bluesky">Bluesky</a>
      <a href="https://s2f.kytta.dev/?text=${encodeURIComponent(meta.title + ' — ' + meta.subtitle)}&url=${encodeURIComponent('https://majordomo.dwk.io/')}" target="_blank" rel="noopener" class="share-btn share-mastodon">Mastodon</a>
      <a href="https://twitter.com/intent/tweet?text=${encodeURIComponent(meta.title + ' — ' + meta.subtitle)}&url=${encodeURIComponent('https://majordomo.dwk.io/')}" target="_blank" rel="noopener" class="share-btn share-twitter">Twitter</a>
