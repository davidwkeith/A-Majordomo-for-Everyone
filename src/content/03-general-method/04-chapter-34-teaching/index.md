---
title: "Teaching This to Someone You Love"
part: 3
order: 4
strategy: null
status: "draft"
...
## Chapter 34: Teaching This to Someone You Love

*"Those who can, do. Those who can't, teach."*
*— [George Bernard Shaw](https://en.wikipedia.org/wiki/Man_and_Superman), 1903*
...
The first session has one job: produce a result the other person finds genuinely useful, on a problem they already have, in under ten minutes.
...
That is the session. You are done. Do not explain what happened. Do not give them a tutorial. Do not show them three more features. One problem, one result, ten minutes. The explanation comes later, if they ask for it. Most will not ask. They will just use it again tomorrow, on the next thing that's bugging them.

> **[SCIENCE]** Social learning theory (Bandura, 1977) consistently shows that observational learning — watching someone else successfully complete a task — is a more powerful driver of behavior adoption than instruction alone. "Watch me do this with my insurance bill" is a more effective introduction to AI tools than any explanation, including this book. Self-efficacy — the belief that one can successfully perform a behavior — is the strongest predictor of whether a person will attempt a new technology. Self-efficacy is built through observation and small wins, not through reading manuals.[^34-1]
...
> **[MEME]** Tim Taylor had access to Al Borland for eight seasons and never once let Al finish a sentence before grabbing the power tool. Do not be Tim. Let the Agent ask its questions. Let the person you're teaching answer them. The spec interview is the work, and the work is the point.
...
This book is licensed [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). That means you can copy it, remix it, adapt it, and redistribute it — for any purpose, including commercial — as long as you give credit.

Make a podcast episode. Film a ten-minute video. Run a workshop at your library. Rewrite Chapter 4 for a Gen-Z audience — embrace the brainrot, just cite your sources. Translate it into Spanish. Print the Quick Reference card from Appendix A and tape it to the fridge at your community center. Read a chapter at your union meeting.
...
> **[TIP]** The fastest way to teach this at a community workshop: bring three real documents — an insurance denial, a lease clause, a medical bill. Have participants paste each one into their Agent and type: "Explain this to me in plain language and tell me what my options are." The room will teach itself.

> **[SCIENCE]** Research on technology diffusion consistently identifies *peer demonstration* — not advertising, not instruction manuals, not institutional endorsement — as the primary driver of adoption in low-trust populations (Rogers, 2003). The person most likely to convince your neighbor to try an AI tool is not a tech company, a government program, or a bestselling author. It is you, at the kitchen table, with their actual problem on the screen.[^34-2]
