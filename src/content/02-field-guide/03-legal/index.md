...
*The law is public. Legal literacy is not. Every contract, statute, regulation, and rights notice that governs your daily life is technically available to you — and practically illegible without the training that law school provides and the billionaire class purchases by the hour. The gap between having rights and exercising them is a literacy gap, and it is expensive by design. The entries that follow do not replace a lawyer. They get you from "I don't know what my rights are" to "I know my rights, I know the process, and I know when I need a lawyer."*
