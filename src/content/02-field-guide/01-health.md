...
<!-- RESEARCH NEEDED: Self-management evidence. Lorig et al. (2001) Stanford Chronic Disease Self-Management Program showed measurable improvement in health status, health behaviors, and ER utilization. The evidence for structured self-management is strong. The access to structured programs is poor. Your Agent can approximate the educational component but cannot provide the peer-support component, which may be equally important. -->

<!-- RESEARCH NEEDED: Financial burden of chronic illness. Out-of-pocket costs average $2,000-$10,000/year depending on condition and insurance type. Medication non-adherence due to cost is 25-30% (CDC data). People are rationing insulin, splitting pills, skipping refills. This is a system failure documented as non-compliance. The framing matters. -->
...
> **[SCIENCE]** The Medicare Part D "donut hole" — the coverage gap where beneficiaries pay a larger share of drug costs — was partially closed by the ACA and further addressed by the Inflation Reduction Act of 2022, which caps out-of-pocket drug costs at $2,000 starting in 2025.[^h6-1]

<!-- RESEARCH NEEDED: Verify donut hole / IRA changes are accurately described for current year. The $2,000 cap is a significant change — the entry needs to reflect current law, not 2023 law. -->

<!-- RESEARCH NEEDED: The 60% Medicare/Medicaid confusion figure needs a specific source. KFF has survey data. The broader point is valid regardless: two programs with nearly identical names, completely different eligibility, run by different levels of government, covering different things. The naming convention is itself a form of structural confusion. -->
...
<!-- RESEARCH NEEDED: State-specific advance directive requirements. The Five Wishes document is legally valid in most but not all states. Some states require specific witness or notarization rules. The entry should point readers to their state's requirements — AARP has a state-by-state guide. Also: POLST (Physician Orders for Life-Sustaining Treatment) vs. advance directive — different documents with different functions. The advance directive states wishes. The POLST translates wishes into medical orders. Many families have one without the other. -->
