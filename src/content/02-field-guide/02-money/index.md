...
> **[SCIENCE]** Americans paid $5.8 billion in overdraft and NSF fees in 2023 at reporting banks alone — down from $12 billion in 2019, but still falling disproportionately on the lowest-balance accounts. The CFPB finalized a rule in December 2024 capping overdraft fees at $5 for large banks. Congress overturned it in May 2025 using the Congressional Review Act, which also bars the CFPB from issuing a similar rule in the future. The average overdraft fee remains approximately $35 — the same whether you overdraw by $2 or $200.[^m1-1]
...
> **[TIP]** Mint shut down in March 2024 — if you were one of its millions of users, you are not alone in the scramble. The current landscape: YNAB ($14.99/month), Monarch ($14.99/month), and Copilot ($13/month, Apple only), all with annual discounts and free trials. But the tool matters less than the habit, and budgeting apps lose most of their users within the first month. Your Agent can help close that gap — ask it to check in weekly on your spending and flag what changed. The accountability is free and it will not judge you. See Li-9 and Developing a Habit.

[^m1-1]: CFPB, ["Overdraft/NSF Revenue in 2023 Down More Than 50% Versus Pre-Pandemic Levels."](https://www.consumerfinance.gov/data-research/research-reports/data-spotlight-overdraft-nsf-revenue-in-2023-down-more-than-50-versus-pre-pandemic-levels-saving-consumers-over-6-billion-annually/) See also [S.J.Res. 18, P.L. 119-10](https://www.congress.gov/crs-product/IN12513) (Congressional Review Act repeal of CFPB overdraft rule, signed May 9, 2025).
...
> **[SCIENCE]** Social Security is not going bankrupt. The 2025 Trustees Report projects the combined trust funds will be depleted in 2034, after which ongoing payroll taxes can still pay 81% of scheduled benefits — indefinitely. That is a funding gap, not a collapse. Congress has multiple tools to close it: raising the cap on taxable earnings (currently $176,100) to cover 90% of wages would close 20% of the gap alone. Adjusting the retirement age or benefit formulas closes more. The system has been fixed before — the 1983 amendments resolved a similar crisis. The anxiety is real. The math is solvable.[^m5-4]

[^m5-4]: Social Security Board of Trustees (2025). [*The 2025 OASDI Trustees Report.*](https://www.ssa.gov/OACT/TR/2025/) CBO, ["Increase the Maximum Taxable Earnings That Are Subject to Social Security Payroll Taxes."](https://www.cbo.gov/budget-options/60955)

> **[FAIRNESS]** Americans lost $5.7 billion to investment scams in 2024 (FTC) — more than any other fraud category, up 24% from the prior year. Crypto pump-and-dumps, forex trading courses, day-trading influencers, and multilevel marketing disguised as "financial freedom" share one trait: if someone is selling you a system to get rich, the system is selling the system. The FTC's 2024 analysis of 70 MLM income disclosures found most participants made under $1,000 per year before expenses. Your Agent can evaluate any pitch: *"Someone is telling me I can make [X] by doing [Y]. Is this legitimate? What are the actual risks they aren't mentioning?"* See the calibration question in Chapter 4.[^m5-3]

[^m5-3]: FTC (2025). ["Reported Losses to Fraud: $12.5 Billion in 2024."](https://www.ftc.gov/news-events/news/press-releases/2025/03/new-ftc-data-show-big-jump-reported-losses-fraud-125-billion-2024) FTC (2024). ["Multi-Level Marketing Income Disclosure Statements: An FTC Staff Report."](https://www.ftc.gov/system/files/ftc_gov/pdf/mlm-ids-report.pdf)
