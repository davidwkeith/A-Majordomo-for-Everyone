...
<!-- art
file: trinitron-s6-diagnose.png
size: full
alt: A Trinitron TV on notebook paper showing an 8-bit scene of Tim in a
     workshop with a large power tool angled dangerously. Al stands
     beside him, arms crossed, watching a slow-motion disaster he
     cannot stop.
brief: TRINITRON CHAPTER OPENER. Tim in a workshop, large power tool at
       an angle suggesting imminent structural danger. Al beside him,
       arms crossed, patient expression of a person watching a slow-motion
       event he cannot stop. The appliance looks fine — for now. Paper
       angle: determined by the drill angle — pointing down-left at
       approximately 45 degrees, the classic tool-applied-incorrectly
       vector. Blue lines extend the drill's trajectory beyond the
       appliance, showing exactly where this is going. Obsession zone:
       the ventilation slots on the side panel, drawn slot by slot — each
       one an individual rectangle, evenly spaced, with the faint shadow
       of the interior visible through each opening.
       Caption: >> AL: Tim, that's not the problem.
       >> TIM: I don't think we need more
       power. >> AL: [sighs] That is never
       the problem.
-->
