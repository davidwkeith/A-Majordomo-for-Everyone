...
> **[SCIENCE]** Research on [health literacy](https://en.wikipedia.org/wiki/Health_literacy) consistently identifies pre-decision information-seeking as a significant predictor of patient satisfaction and outcomes (Berkman et al., 2011). The same principle applies to financial and legal decisions: the quality of commitment correlates with the quality of pre-commitment information. Your Agent reduces the cost of that research to nearly zero.[^s7-1]

[^s7-1]: Berkman, N.D. et al. (2011). "[Low health literacy and health outcomes: An updated systematic review](https://doi.org/10.7326/0003-4819-155-2-201107190-00005)." *Annals of Internal Medicine*, 155(2), 97-107.

**Worked examples:** Before a surgical procedure. Before signing a non-compete clause. Before choosing between two college financial aid offers.
