...
[^s9-1]: Stokes, P.D. (2006). [*Creativity from Constraints: The Psychology of Breakthrough.*](https://psycnet.apa.org/record/2005-11603-000) Springer. The research on jazz improvisation, architectural design, and literary composition all point to the same finding: meaningful constraints produce more creative output than open-ended instructions.
